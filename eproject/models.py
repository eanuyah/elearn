...
class Answers(models.Model):
    ...
    studentanswer = models.TextField(blank=True, null=True)
...
class Months(models.Model):
    id = models.IntegerField(primary_key=True)
    monthname = models.CharField(max_length=50, blank=True, null=True)
...
class Regtable(models.Model):
    ...
    imagefile = models.CharField(max_length=255, blank=True, null=True)
...
class Stafftasks(models.Model):
    tasktitle = models.CharField(max_length=255)
    description = models.TextField(blank=True, null=True)
    fileuploadlink = models.CharField(max_length=255, blank=True, null=True)
